...
Product 5724-J08, 5724-I63, 5724-H88, 5724-H89, 5655-N02, 5733-W70,
(C) COPYRIGHT International Business Machines Corp., 1996, 2011
All Rights Reserved *
...
def setCustomPropertyOnObject(object_id, propname, propvalue):
    ...
    if value != None:
        # Exists - need change?
        if value == propvalue:
            log.INFO("SKIPPED -  property %s already set" %(propname))
        ...
        for id in propsidlist:
            ...
            if name == propname:
                ...
                AdminConfig.remove(id)
                log.INFO("UPDATE property %s Applied to %s " %(propname,propvalue))
        ...
        AdminConfig.modify(object_id, [['properties', [[['name', propname], ['value', propvalue]]]]])
        log.INFO("ADDED property %s Applied to %s " %(propname,propvalue))
